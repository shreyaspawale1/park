class ActivitiesController < ApplicationController
  ...
  def create
    ...
    the_activity.duration = params.fetch("query_duration")
    ...
    if the_activity.valid?
      ...
      redirect_to("/activities", { :notice => "Activity failed to create successfully." })
    end
  end
  ...
  def update
    ...
    if the_activity.valid?
      ...
      redirect_to("/activities/#{the_activity.id}", { :alert => "Activity failed to update successfully." })
    end
  end
